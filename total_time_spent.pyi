...
class AudioPlayer(Audio):
    """ Represents audio file with higher level capabilities.
    Probably takes up more resource. """
    ...
    def __init__(self, *,
        ...
        super().__init__(filepath=filepath, absolute=absolute, filename=filename, loader=loader)
