...
class Main:
    ...
    def __init__(self, song_folder: Path, keyboard: Keyboard):
        n = 1
        self.song = Song(song_folder, n)
        self.keyboard = keyboard
        self.incoming_hit_objects = self.hit_objects = self.song.beatmaps[n]
    ...
    def on_draw(self):
        # ็ HACK skip drawing this frame if lagging i.e. update again before drawing
